...
- (void)layoutSubviews {
    ...
    style.lineBreakMode = detailsLabel.lineBreakMode;
    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName : detailsLabel.font, NSParagraphStyleAttributeName : style} context:nil].size;
